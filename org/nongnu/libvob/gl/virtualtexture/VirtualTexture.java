...
/** An object that represents a texture to be incrementally loaded or unloaded.
 * (I think; the original javadoc talked about it being "re-forgotten." -Benja)
...
public class VirtualTexture {
    ...
    public final GL.IndirectTexture indirectTexture;
    public final MipzipFile mipzipFile;
}
