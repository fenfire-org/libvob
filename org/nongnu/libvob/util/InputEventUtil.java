...
public class InputEventUtil {
	...
	} catch (java.security.AccessControlException e) { ; }// applet
	...
	if(kc == k.VK_DELETE)
	    ...
	    t = "Enter";
	else if(kc == k.VK_NUMPAD1)
	    t = "Numpad-1";
	else if(kc == k.VK_NUMPAD2)
	    t = "Numpad-2";
	else if(kc == k.VK_NUMPAD3)
	    t = "Numpad-3";
	else if(kc == k.VK_NUMPAD4)
	    t = "Numpad-4";
	else if(kc == k.VK_NUMPAD5)
	    t = "Numpad-5";
	else if(kc == k.VK_NUMPAD6)
	    t = "Numpad-6";
	else if(kc == k.VK_NUMPAD7)
	    t = "Numpad-7";
	else if(kc == k.VK_NUMPAD8)
	    t = "Numpad-8";
	else if(kc == k.VK_NUMPAD9)
	    t = "Numpad-9";
	...
	if(t.equals("\033")) t = "Esc";
	    ...
	    else if(k.isShiftDown() && (k.isAltDown() ||
					k.isControlDown()))
		t = "Shift-" + t;
	} else if(t.equals("") ||
