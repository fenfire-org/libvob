/* RealtimeCollection.java -- Abstract implementation of most of Collection
   Copyright (C) 1998, 2000, 2001, 2005  Free Software Foundation, Inc.
   Copyright (C) 2005 Benja Fallenstein

This file is part of Libvob. (It was adapted from GNU Classpath.)

Libvob is free software; you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation; either version 2, or (at your option)
any later version.

Libvob is distributed in the hope that it will be useful, but
WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU
General Public License for more details.

You should have received a copy of the GNU General Public License
along with Libvob; see the file COPYING.  If not, write to the
...
/** An abstract implementation of List, like AbstractCollection, but
 ...
 * @author Benja Fallenstein (adaptation for RealtimeObject)
 * @see Collection
 * @see AbstractSet
 * @see AbstractList
 * @since 1.2
 ...
 */
public abstract class RealtimeCollection extends RealtimeObject
    implements Collection
{
  ...
  /**
   * Creates a Text representation of the Collection. The string returned is
   * of the form "[a, b, ...]" where a and b etc are the results of calling
   * toString on the elements of the collection. This implementation obtains an
   * Iterator over the Collection and adds each element as it is returned 
   * by the iterator.
   *
   * @return a Text representation of the Collection
   */
  public Text toText()
  {
    Iterator itr = iterator();
    TextBuilder t = TextBuilder.newInstance();
    t.append(OPENING_BRACKET);
    ...
    t.append(CLOSING_BRACKET);
    return t.toText();
  }

  private static final Text
      OPENING_BRACKET = Text.valueOf("["),
      CLOSING_BRACKET = Text.valueOf("]"),
      COMMA = Text.valueOf(", ");
